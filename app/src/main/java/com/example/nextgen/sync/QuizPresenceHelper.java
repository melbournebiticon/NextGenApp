...
import com.example.nextgen.offline.QuizEntity;
import com.example.nextgen.offline.QuizPendingPresence;
...
public class QuizPresenceHelper {
    ...
    public static final String ACTION_QUIZ_PRESENCE_SAVED = "com.example.nextgen.action.QUIZ_PRESENCE_SAVED";
    ...
    public static void saveQuizPresenceLocallyAndEnqueue(Context ctx, String quizId, String studentId, ExamMetadata meta) {
        ...
        new Thread(() -> {
            try {
                ...
                OneTimeWorkRequest w = new OneTimeWorkRequest.Builder(com.example.nextgen.work.QuizPresenceSyncWorker.class).build();
