...
import com.example.nextgen.student.QuizModel;
...
public final class QuizCacheManager {
    ...
    public static void saveSnapshot(Context ctx, DataSnapshot snapshot) {
        try {
            ...
            final com.example.nextgen.offline.AppDatabase db = com.example.nextgen.offline.AppDatabase.getInstance(ctx);
    ...
    public static List<QuizModel> loadCachedQuizzes(Context ctx) {
        ...
        try {
            com.example.nextgen.offline.AppDatabase db = com.example.nextgen.offline.AppDatabase.getInstance(ctx);
