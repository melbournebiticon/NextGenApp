...
public class StudentDashboardActivity extends AppCompatActivity
    ...
    // ==================== TOOLBAR MENU (Profile Icon + Popup) ====================
    @Override
    ...
    private void showProfileMenu() {
        ...
        popup.setOnMenuItemClickListener(menuItem -> {
            ...
            if (id == R.id.action_view_profile) { // ✅ match XML ID
                Intent intent = new Intent(this, StudentProfileActivity.class);
                startActivity(intent);
                return true;
            } else if (id == R.id.action_logout) { // ✅ match XML ID
                handleLogout();
                return true;
            }
            return false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 🟢 FIX: Initialize the adapter ONCE and set it to the RecyclerView.
    ...
    private void startPeriodicExamFetch(StudentModel student) {
        ...
        examRefreshRunnable = new Runnable() {
            @Override
            public void run() {
                Log.d(TAG, "Running periodic exam fetch. Interval: " + REFRESH_INTERVAL + "ms");
    ...
    private void updateExamRecyclerView() {
        ...
        // 🟢 FIX: Call notifyDataSetChanged() on the existing adapter instance.
        // Tiyakin na ang adapter ay na-initialize na sa onCreate()
        if (examAdapter != null) {
