...
public class TakeQuizActivity extends AppCompatActivity {
    ...
    private void resolveStudentIdAndMarkPresent(String quizId, Runnable afterMarking) {
        ...
        String stored = null;
        try { stored = new com.example.nextgen.SessionManager(this).getStudentId(); } catch (Exception ignored) {}
        ...
        studentsRef.orderByChild("uid").equalTo(uid).limitToFirst(1)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (found != null) {
                            try { new com.example.nextgen.SessionManager(TakeQuizActivity.this).saveStudentId(found); } catch (Exception ignored) {}
