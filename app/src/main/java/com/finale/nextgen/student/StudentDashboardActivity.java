...
public class StudentDashboardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_view_exam) {
                // Put your ExamActivity launching code here!
                                                        ...
                                                        new Thread(() -> {
                                                            ...
                                                            runOnUiThread(() -> {
                                                                synchronized (examList) {
                                                                    ...
                                                                    new Thread(() -> {
                                                                        com.finale.nextgen.offline.AppDatabase db2 = com.finale.nextgen.offline.AppDatabase.getInstance(StudentDashboardActivity.this);
    ...
    private void cacheAllExamQuestionsForOffline(List<ExamModel> exams) {
        ...
        for (ExamModel exam : exams) {
            ...
            new Thread(() -> {
                com.finale.nextgen.offline.OfflineExamManager mgr = new com.finale.nextgen.offline.OfflineExamManager(StudentDashboardActivity.this);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        new Thread(() -> {
                            com.finale.nextgen.offline.OfflineExamManager mgr2 =
                                    new com.finale.nextgen.offline.OfflineExamManager(StudentDashboardActivity.this);
