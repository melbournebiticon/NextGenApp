    ...
    public void onBindViewHolder(@NonNull ExamViewHolder holder, int position) {
        ...
        if (!exam.isPresent()) {
            ...
            holder.btnTakeExam.setOnClickListener(v -> {
                ...
                bgExecutor.execute(() -> {
                    String studentId = com.finale.nextgen.SessionManager.getStudentId(context);
                    ...
                    com.finale.nextgen.offline.AppDatabase db = com.finale.nextgen.offline.AppDatabase.getInstance(context.getApplicationContext());
